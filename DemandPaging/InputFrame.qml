...
Frame{
    ...
    Column{
        ...
        Text {
            ...
            width: parent.width
            height: 50
            text: qsTr("Demand Paging Simulation")
            font.bold: true
        ...
        Row{
            ...
            RComboBox{
                ...
                height: parent.height
                model: ["First In First Served (FIFS)", "Least Recently Used (LRU)", "Least Frequently Used (LFU)",
                    "Most Frequently Used (MFU)", "Optimal", "Approximation Based FIFO"]
            }
        }
